...
public class SinglePlayer extends JPanel implements ActionListener {
    ...
    public SinglePlayer() throws IOException {
        ...
        this.addMouseListener(new SinglePlayer.MyMouseAdapter());
        this.addMouseMotionListener(new SinglePlayer.MyMouseAdapter());
    ...
    private void getAiMovement() {
        tabuleiro = Tabuleiro.clone(Ai.getAiMovement(tabuleiro));
        repaint();
        vez = vez == Peca.Cor.BRANCO ? Peca.Cor.PRETO : Peca.Cor.BRANCO;
    }
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if(vez== Peca.Cor.BRANCO) {
                ...
                // Se o movimento for inválido, verifica se outra peça foi selecionada:
                        ...
                        tabuleiro[linha][coluna].cor == Peca.Cor.BRANCO) {
